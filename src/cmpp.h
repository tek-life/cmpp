...
extern int cmpp_recv_timeout(cmpp_sock_t *sock, void *pack, size_t len, unsigned timeout);
...
extern int cmpp_sock_recv(cmpp_sock_t *sock, unsigned char *buff, size_t len, unsigned long long timeout);
