...
extern void cmpp_pack_add_string(void *pack, unsigned char *val, size_t vallen, size_t *offset, size_t size);
extern void cmpp_pack_set_string(void *pack, size_t offset, unsigned char *val, size_t vallen, size_t size);
